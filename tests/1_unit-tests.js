...
suite('Unit Tests', function(){
    ...
    suite('Function convertHandler.getNum(input)', function() {
        ...
        test('Double Fraction Error', function(done) {
            ...
            assert.equal(convertHandler.getNum(input), '1/2L', 'Error: should correctly return an error on a double-fraction (i.e. 3/2/3)');//change this later
            done();
        });
        ...
        test('Default Input of 1', function(done) {
            ...
            assert.equal(convertHandler.getNum(input), '1L', 'Error: input should correctly default to a numerical input of 1 when no numerical input is provided.');
            done();
        });
    });
